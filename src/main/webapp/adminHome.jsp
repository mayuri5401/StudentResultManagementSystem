...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Institution doesn't own for the errors or omissions, if any, in this statement. Designed & Developed by MAYURI</h5></center>
  <hr class="new1">
<center><h5>© 2018 DYPTC All Rights Reserved. Designed By MAYUI NARKHEDE</h5></center> 
  <hr class="new1">
<br>
</body>
</html>